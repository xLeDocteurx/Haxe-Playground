...
class HXCPP_CLASS_ATTRIBUTES Main_Fields__obj : public ::hx::Object
{
	...
	public:
		...
		static int float2color(Float rr,Float rg,Float rb);
		static ::Dynamic float2color_dyn();

		static Float fract(Float input);
		static ::Dynamic fract_dyn();

		static bool isValidNoiseInput(Float input);
		static ::Dynamic isValidNoiseInput_dyn();

		static Float interpolateLinear(Float a,Float b,Float x);
		static ::Dynamic interpolateLinear_dyn();

		static Float interpolateCubic(Float a,Float b,Float x);
		static ::Dynamic interpolateCubic_dyn();

		static Float interpolateCosine(Float a,Float b,Float x);
		static ::Dynamic interpolateCosine_dyn();
