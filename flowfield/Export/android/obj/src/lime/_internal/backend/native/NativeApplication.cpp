...
HXLINE(  82)		::lime::_hx_system::Sensor_obj::registerSensor(::lime::_hx_system::SensorType_obj::ACCELEROMETER_dyn(),0);
...
HXLINE( 121)		::lime::_internal::backend::native::NativeCFFI_obj::lime_sensor_event_manager_register(::hx::DynamicPtr(this->handleSensorEvent_dyn()),::hx::DynamicPtr(this->sensorEventInfo));
...
HXDLIN( 317)			if ((keyCode == (int)1073742094)) {
HXLINE( 317)				_hx_tmp2 = (modifier == 0);
            			}
            			else {
HXLINE( 317)				_hx_tmp2 = false;
            			}
HXDLIN( 317)			if (_hx_tmp2) {
HXLINE( 317)				_hx_tmp1 = (type == 1);
            			}
            			else {
HXLINE( 317)				_hx_tmp1 = false;
            			}
HXDLIN( 317)			if (_hx_tmp1) {
HXLINE( 317)				_hx_tmp = !(window->onKeyUp->canceled);
            			}
            			else {
HXLINE( 317)				_hx_tmp = false;
            			}
HXDLIN( 317)			if (_hx_tmp) {
HXLINE( 319)				 ::lime::_hx_system::JNIStaticField mainActivity = ::lime::_hx_system::JNI_obj::createStaticField(HX_("org/haxe/extension/Extension",b1,f4,56,51),HX_("mainActivity",28,83,72,14),HX_("Landroid/app/Activity;",52,cb,53,45));
HXLINE( 320)				 ::Dynamic moveTaskToBack = ::lime::_hx_system::JNI_obj::createMemberMethod(HX_("android/app/Activity",7d,f6,a1,af),HX_("moveTaskToBack",d8,80,a8,0c),HX_("(Z)Z",c3,f7,b4,1a),null(),null());
HXLINE( 322)				moveTaskToBack(mainActivity->get(),true);
            			}
            		}
            	}
