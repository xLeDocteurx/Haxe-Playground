...
HX_LOCAL_STACK_FRAME(_hx_pos_0d29a7d2e6a1bcbb_97__new,"lime.utils._Int32Array.Int32Array_Impl_","_new",0x1ba841aa,"lime.utils._Int32Array.Int32Array_Impl_._new","lime/utils/Int32Array.hx",97,0x9a557d3b)
HX_LOCAL_STACK_FRAME(_hx_pos_0d29a7d2e6a1bcbb_130_subarray,"lime.utils._Int32Array.Int32Array_Impl_","subarray",0x0650d8e2,"lime.utils._Int32Array.Int32Array_Impl_.subarray","lime/utils/Int32Array.hx",130,0x9a557d3b)
HX_LOCAL_STACK_FRAME(_hx_pos_0d29a7d2e6a1bcbb_135_fromBytes,"lime.utils._Int32Array.Int32Array_Impl_","fromBytes",0x68e59db8,"lime.utils._Int32Array.Int32Array_Impl_.fromBytes","lime/utils/Int32Array.hx",135,0x9a557d3b)
HX_LOCAL_STACK_FRAME(_hx_pos_0d29a7d2e6a1bcbb_140_toBytes,"lime.utils._Int32Array.Int32Array_Impl_","toBytes",0xaed73c47,"lime.utils._Int32Array.Int32Array_Impl_.toBytes","lime/utils/Int32Array.hx",140,0x9a557d3b)
HX_LOCAL_STACK_FRAME(_hx_pos_0d29a7d2e6a1bcbb_145_get_length,"lime.utils._Int32Array.Int32Array_Impl_","get_length",0x84e00db8,"lime.utils._Int32Array.Int32Array_Impl_.get_length","lime/utils/Int32Array.hx",145,0x9a557d3b)
HX_LOCAL_STACK_FRAME(_hx_pos_0d29a7d2e6a1bcbb_163_toString,"lime.utils._Int32Array.Int32Array_Impl_","toString",0x373e5575,"lime.utils._Int32Array.Int32Array_Impl_.toString","lime/utils/Int32Array.hx",163,0x9a557d3b)
HX_LOCAL_STACK_FRAME(_hx_pos_0d29a7d2e6a1bcbb_92_boot,"lime.utils._Int32Array.Int32Array_Impl_","boot",0x1da4b07b,"lime.utils._Int32Array.Int32Array_Impl_.boot","lime/utils/Int32Array.hx",92,0x9a557d3b)
namespace lime{
namespace utils{
...
int Int32Array_Impl__obj::BYTES_PER_ELEMENT;
 ...
 ::lime::utils::ArrayBufferView Int32Array_Impl__obj::_new( ::Dynamic elements, ::haxe::io::Bytes buffer,::cpp::VirtualArray array, ::lime::utils::ArrayBufferView view, ::Dynamic __o_byteoffset, ::Dynamic len){
            		 ::Dynamic byteoffset = __o_byteoffset;
            		if (::hx::IsNull(__o_byteoffset)) byteoffset = 0;
            	HX_GC_STACKFRAME(&_hx_pos_0d29a7d2e6a1bcbb_97__new)
HXDLIN(  97)		 ::lime::utils::ArrayBufferView this1;
HXLINE( 100)		if (::hx::IsNotNull( elements )) {
HXLINE( 102)			this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,3);
            		}
            		else {
HXLINE( 104)			if (::hx::IsNotNull( array )) {
HXLINE( 106)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,3);
...
HXLINE( 116)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,3);
...
HXLINE( 120)						 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,3);
...
HXLINE( 124)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for Int32Array",9b,2e,53,61)));
            					}
            				}
            			}
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(Int32Array_Impl__obj,_new,return )

 ::lime::utils::ArrayBufferView Int32Array_Impl__obj::subarray( ::lime::utils::ArrayBufferView this1,int begin, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_0d29a7d2e6a1bcbb_130_subarray)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Int32Array_Impl__obj,subarray,return )
 ...
 ::lime::utils::ArrayBufferView Int32Array_Impl__obj::fromBytes( ::haxe::io::Bytes bytes, ::Dynamic __o_byteOffset, ::Dynamic len){
            		 ::Dynamic byteOffset = __o_byteOffset;
            		if (::hx::IsNull(__o_byteOffset)) byteOffset = 0;
            	HX_GC_STACKFRAME(&_hx_pos_0d29a7d2e6a1bcbb_135_fromBytes)
...
HXDLIN( 135)			this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,3);
            		}
            		else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Int32Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes Int32Array_Impl__obj::toBytes( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_0d29a7d2e6a1bcbb_140_toBytes)
...
int Int32Array_Impl__obj::get_length( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_0d29a7d2e6a1bcbb_145_get_length)
...
::String Int32Array_Impl__obj::toString( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_0d29a7d2e6a1bcbb_163_toString)
HXDLIN( 163)		if (::hx::IsNotNull( this1 )) {
HXDLIN( 163)			return ((((HX_("Int32Array [byteLength:",a6,a7,b7,bd) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
            		else {
...
{
{
            	HX_STACKFRAME(&_hx_pos_0d29a7d2e6a1bcbb_92_boot)
