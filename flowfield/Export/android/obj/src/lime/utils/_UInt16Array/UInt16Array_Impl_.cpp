...
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_97__new,"lime.utils._UInt16Array.UInt16Array_Impl_","_new",0xdf2a42b2,"lime.utils._UInt16Array.UInt16Array_Impl_._new","lime/utils/UInt16Array.hx",97,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_130_subarray,"lime.utils._UInt16Array.UInt16Array_Impl_","subarray",0xb49bfdea,"lime.utils._UInt16Array.UInt16Array_Impl_.subarray","lime/utils/UInt16Array.hx",130,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_135_fromBytes,"lime.utils._UInt16Array.UInt16Array_Impl_","fromBytes",0x3c5adfb0,"lime.utils._UInt16Array.UInt16Array_Impl_.fromBytes","lime/utils/UInt16Array.hx",135,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_140_toBytes,"lime.utils._UInt16Array.UInt16Array_Impl_","toBytes",0x3715903f,"lime.utils._UInt16Array.UInt16Array_Impl_.toBytes","lime/utils/UInt16Array.hx",140,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_145_get_length,"lime.utils._UInt16Array.UInt16Array_Impl_","get_length",0xb80484c0,"lime.utils._UInt16Array.UInt16Array_Impl_.get_length","lime/utils/UInt16Array.hx",145,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_163_toString,"lime.utils._UInt16Array.UInt16Array_Impl_","toString",0xe5897a7d,"lime.utils._UInt16Array.UInt16Array_Impl_.toString","lime/utils/UInt16Array.hx",163,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_92_boot,"lime.utils._UInt16Array.UInt16Array_Impl_","boot",0xe126b183,"lime.utils._UInt16Array.UInt16Array_Impl_.boot","lime/utils/UInt16Array.hx",92,0x124ad8bc)
namespace lime{
namespace utils{
...
int UInt16Array_Impl__obj::BYTES_PER_ELEMENT;
 ...
 ::lime::utils::ArrayBufferView UInt16Array_Impl__obj::_new( ::Dynamic elements, ::haxe::io::Bytes buffer,::cpp::VirtualArray array, ::lime::utils::ArrayBufferView view, ::Dynamic __o_byteoffset, ::Dynamic len){
            		 ::Dynamic byteoffset = __o_byteoffset;
            		if (::hx::IsNull(__o_byteoffset)) byteoffset = 0;
            	HX_GC_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_97__new)
HXDLIN(  97)		 ::lime::utils::ArrayBufferView this1;
HXLINE( 100)		if (::hx::IsNotNull( elements )) {
HXLINE( 102)			this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,6);
            		}
            		else {
HXLINE( 104)			if (::hx::IsNotNull( array )) {
HXLINE( 106)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXLINE( 116)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXLINE( 120)						 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,6);
...
HXLINE( 124)						HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for UInt16Array",0a,c7,2d,d5)));
            					}
            				}
            			}
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(UInt16Array_Impl__obj,_new,return )

 ::lime::utils::ArrayBufferView UInt16Array_Impl__obj::subarray( ::lime::utils::ArrayBufferView this1,int begin, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_130_subarray)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt16Array_Impl__obj,subarray,return )
 ...
 ::lime::utils::ArrayBufferView UInt16Array_Impl__obj::fromBytes( ::haxe::io::Bytes bytes, ::Dynamic __o_byteOffset, ::Dynamic len){
            		 ::Dynamic byteOffset = __o_byteOffset;
            		if (::hx::IsNull(__o_byteOffset)) byteOffset = 0;
            	HX_GC_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_135_fromBytes)
...
HXDLIN( 135)			this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,6);
            		}
            		else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt16Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes UInt16Array_Impl__obj::toBytes( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_140_toBytes)
...
int UInt16Array_Impl__obj::get_length( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_145_get_length)
...
::String UInt16Array_Impl__obj::toString( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_163_toString)
HXDLIN( 163)		if (::hx::IsNotNull( this1 )) {
HXDLIN( 163)			return ((((HX_("UInt16Array [byteLength:",b7,19,59,35) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
            		else {
...
{
{
            	HX_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_92_boot)
HXDLIN(  92)		BYTES_PER_ELEMENT = 2;
            	}
}
