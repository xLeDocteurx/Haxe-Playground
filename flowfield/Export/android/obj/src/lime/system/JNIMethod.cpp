...
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_268_callMember,"lime.system.JNIMethod","callMember",0x1acfd846,"lime.system.JNIMethod.callMember","lime/system/JNI.hx",268,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_280_callStatic,"lime.system.JNIMethod","callStatic",0x1c15d29a,"lime.system.JNIMethod.callStatic","lime/system/JNI.hx",280,0x21970b7f)
...
bool JNIMethod_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JNIMethod_obj::callMember(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_268_callMember)
HXLINE( 270)		 ::Dynamic jobject = args->shift();
HXLINE( 271)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_call_member(::hx::DynamicPtr(this->method),::hx::DynamicPtr(jobject),::hx::DynamicPtr(args))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,callMember,return )
 ...
 ::Dynamic JNIMethod_obj::callStatic(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_280_callStatic)
HXDLIN( 280)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_call_static(::hx::DynamicPtr(this->method),::hx::DynamicPtr(args))) );
            	}
