...
HX_LOCAL_STACK_FRAME(_hx_pos_241b089bf20ccbef_238_get,"lime.system.JNIStaticField","get",0x7995bc55,"lime.system.JNIStaticField.get","lime/system/JNI.hx",238,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_241b089bf20ccbef_245_set,"lime.system.JNIStaticField","set",0x799ed761,"lime.system.JNIStaticField.set","lime/system/JNI.hx",245,0x21970b7f)
namespace lime{
...
bool JNIStaticField_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JNIStaticField_obj::get(){
            	HX_STACKFRAME(&_hx_pos_241b089bf20ccbef_238_get)
HXDLIN( 238)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_get_static(::hx::DynamicPtr(this->field))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(JNIStaticField_obj,get,return )
 ...
 ::Dynamic JNIStaticField_obj::set( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_241b089bf20ccbef_245_set)
HXLINE( 247)		::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_set_static(::hx::DynamicPtr(this->field),::hx::DynamicPtr(value));
...
::hx::ObjectPtr< JNIStaticField_obj > JNIStaticField_obj::__alloc(::hx::Ctx *_hx_ctx, ::Dynamic field) {
