...
HXLINE( 192)			 ::Dynamic getDisplayDPI = ::lime::_hx_system::JNI_obj::createStaticMethod(HX_("org/haxe/lime/GameActivity",1d,61,c7,a4),HX_("getDisplayXDPI",31,6c,16,bf),HX_("()D",23,7e,1e,00),null(),null());
HXLINE( 193)			display->dpi = ( (Float)(::Math_obj::round(( (Float)(getDisplayDPI()) ))) );
...
HXLINE( 307)			 ::Dynamic openFile = ::lime::_hx_system::JNI_obj::createStaticMethod(HX_("org/haxe/lime/GameActivity",1d,61,c7,a4),HX_("openFile",66,ab,f7,e4),HX_("(Ljava/lang/String;)V",7f,b4,bc,c7),null(),null());
HXLINE( 308)			openFile(path);
            		}
            	}
...
HXLINE( 326)			 ::Dynamic openURL = ::lime::_hx_system::JNI_obj::createStaticMethod(HX_("org/haxe/lime/GameActivity",1d,61,c7,a4),HX_("openURL",c5,bd,35,40),HX_("(Ljava/lang/String;Ljava/lang/String;)V",49,45,e8,06),null(),null());
HXLINE( 327)			openURL(url,target);
            		}
            	}
...
HXLINE( 606)			::String manufacturer = ( (::String)(::lime::_hx_system::JNI_obj::createStaticField(HX_("android/os/Build",c3,62,50,61),HX_("MANUFACTURER",51,72,a3,b2),HX_("Ljava/lang/String;",ca,05,90,bc))->get()) );
HXLINE( 607)			::String model = ( (::String)(::lime::_hx_system::JNI_obj::createStaticField(HX_("android/os/Build",c3,62,50,61),HX_("MODEL",89,5b,46,8a),HX_("Ljava/lang/String;",ca,05,90,bc))->get()) );
HXLINE( 608)			bool _hx_tmp;
HXDLIN( 608)			if (::hx::IsNotNull( manufacturer )) {
HXLINE( 608)				_hx_tmp = ::hx::IsNotNull( model );
            			}
            			else {
HXLINE( 608)				_hx_tmp = false;
            			}
HXDLIN( 608)			if (_hx_tmp) {
HXLINE( 610)				::String _hx_tmp = model.toLowerCase();
HXDLIN( 610)				if (::StringTools_obj::startsWith(_hx_tmp,manufacturer.toLowerCase())) {
HXLINE( 612)					model = ::StringTools_obj::trim(model.substr(manufacturer.length,null()));
HXLINE( 613)					while(::StringTools_obj::startsWith(model,HX_("-",2d,00,00,00))){
HXLINE( 615)						model = ::StringTools_obj::trim(model.substr(1,null()));
            					}
            				}
HXLINE( 618)				::lime::_hx_system::System_obj::_hx___deviceModel = model;
            			}
            		}
...
HXLINE( 641)			::String vendor = ( (::String)(::lime::_hx_system::JNI_obj::createStaticField(HX_("android/os/Build",c3,62,50,61),HX_("MANUFACTURER",51,72,a3,b2),HX_("Ljava/lang/String;",ca,05,90,bc))->get()) );
HXLINE( 642)			if (::hx::IsNotNull( vendor )) {
HXLINE( 644)				::String _hx_tmp = vendor.charAt(0).toUpperCase();
HXDLIN( 644)				::lime::_hx_system::System_obj::_hx___deviceVendor = (_hx_tmp + vendor.substr(1,null()));
            			}
            		}
...
HXLINE( 753)			::lime::_hx_system::System_obj::_hx___platformName = HX_("Android",0f,c3,f5,69);
            		}
...
HXLINE( 789)			::String release = ( (::String)(::lime::_hx_system::JNI_obj::createStaticField(HX_("android/os/Build$VERSION",17,25,43,51),HX_("RELEASE",a7,59,c1,d8),HX_("Ljava/lang/String;",ca,05,90,bc))->get()) );
HXLINE( 790)			::String api = ( (::String)(::lime::_hx_system::JNI_obj::createStaticField(HX_("android/os/Build$VERSION",17,25,43,51),HX_("SDK_INT",6a,79,ca,19),HX_("I",49,00,00,00))->get()) );
HXLINE( 791)			bool _hx_tmp;
HXDLIN( 791)			if (::hx::IsNotNull( release )) {
HXLINE( 791)				_hx_tmp = ::hx::IsNotNull( api );
            			}
            			else {
HXLINE( 791)				_hx_tmp = false;
            			}
HXDLIN( 791)			if (_hx_tmp) {
HXLINE( 791)				::lime::_hx_system::System_obj::_hx___platformVersion = (((release + HX_(" (API ",6e,92,a6,fe)) + api) + HX_(")",29,00,00,00));
            			}
            		}
