...
HX_LOCAL_STACK_FRAME(_hx_pos_6a03f50885e20814_206_get,"lime.system.JNIMemberField","get",0x79fba129,"lime.system.JNIMemberField.get","lime/system/JNI.hx",206,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_6a03f50885e20814_213_set,"lime.system.JNIMemberField","set",0x7a04bc35,"lime.system.JNIMemberField.set","lime/system/JNI.hx",213,0x21970b7f)
namespace lime{
...
bool JNIMemberField_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JNIMemberField_obj::get( ::Dynamic jobject){
            	HX_STACKFRAME(&_hx_pos_6a03f50885e20814_206_get)
HXDLIN( 206)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_get_member(::hx::DynamicPtr(this->field),::hx::DynamicPtr(jobject))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMemberField_obj,get,return )
 ...
 ::Dynamic JNIMemberField_obj::set( ::Dynamic jobject, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_6a03f50885e20814_213_set)
HXLINE( 215)		::lime::_internal::backend::native::NativeCFFI_obj::lime_jni_set_member(::hx::DynamicPtr(this->field),::hx::DynamicPtr(jobject),::hx::DynamicPtr(value));
