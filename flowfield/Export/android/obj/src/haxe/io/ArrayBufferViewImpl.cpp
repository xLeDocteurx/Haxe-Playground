...
HX_DEFINE_STACK_FRAME(_hx_pos_aa17fb9e39ce4936_32_new,"haxe.io.ArrayBufferViewImpl","new",0x853f5310,"haxe.io.ArrayBufferViewImpl.new","/usr/local/lib/haxe/std/haxe/io/ArrayBufferView.hx",32,0x969ed6fd)
namespace haxe{
namespace io{

void ArrayBufferViewImpl_obj::__construct( ::haxe::io::Bytes bytes,int pos,int length){
            	HX_STACKFRAME(&_hx_pos_aa17fb9e39ce4936_32_new)
