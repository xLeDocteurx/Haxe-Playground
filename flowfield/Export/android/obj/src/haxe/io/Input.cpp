...
HX_LOCAL_STACK_FRAME(_hx_pos_220702dcc8429dc4_163_readUntil,"haxe.io.Input","readUntil",0xc6fe56a4,"haxe.io.Input.readUntil","/usr/local/lib/haxe/std/haxe/io/Input.hx",163,0x3b290ab1)
...
HX_LOCAL_STACK_FRAME(_hx_pos_220702dcc8429dc4_200_readFloat,"haxe.io.Input","readFloat",0x22a563a2,"haxe.io.Input.readFloat","/usr/local/lib/haxe/std/haxe/io/Input.hx",200,0x3b290ab1)
HX_LOCAL_STACK_FRAME(_hx_pos_220702dcc8429dc4_208_readDouble,"haxe.io.Input","readDouble",0x1f86d24b,"haxe.io.Input.readDouble","/usr/local/lib/haxe/std/haxe/io/Input.hx",208,0x3b290ab1)
...
HX_LOCAL_STACK_FRAME(_hx_pos_220702dcc8429dc4_269_readUInt24,"haxe.io.Input","readUInt24",0x05cae0f6,"haxe.io.Input.readUInt24","/usr/local/lib/haxe/std/haxe/io/Input.hx",269,0x3b290ab1)
...
::String Input_obj::readUntil(int end){
            	HX_GC_STACKFRAME(&_hx_pos_220702dcc8429dc4_163_readUntil)
...
Float Input_obj::readFloat(){
            	HX_STACKFRAME(&_hx_pos_220702dcc8429dc4_200_readFloat)
...
Float Input_obj::readDouble(){
            	HX_STACKFRAME(&_hx_pos_220702dcc8429dc4_208_readDouble)
...
int Input_obj::readUInt24(){
            	HX_STACKFRAME(&_hx_pos_220702dcc8429dc4_269_readUInt24)
HXLINE( 270)		int ch1 = this->readByte();
HXLINE( 271)		int ch2 = this->readByte();
HXLINE( 272)		int ch3 = this->readByte();
HXLINE( 273)		if (this->bigEndian) {
HXLINE( 273)			return ((ch3 | (ch2 << 8)) | (ch1 << 16));
            		}
            		else {
HXLINE( 273)			return ((ch1 | (ch2 << 8)) | (ch3 << 16));
            		}
HXDLIN( 273)		return 0;
            	}
