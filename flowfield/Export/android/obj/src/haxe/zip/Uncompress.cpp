...
HX_DEFINE_STACK_FRAME(_hx_pos_5c4f2394ea68a40f_30_new,"haxe.zip.Uncompress","new",0x34f307c2,"haxe.zip.Uncompress.new","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",30,0x2e2bbf2e)
HX_LOCAL_STACK_FRAME(_hx_pos_5c4f2394ea68a40f_34_execute,"haxe.zip.Uncompress","execute",0xb3589a97,"haxe.zip.Uncompress.execute","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",34,0x2e2bbf2e)
HX_LOCAL_STACK_FRAME(_hx_pos_5c4f2394ea68a40f_38_setFlushMode,"haxe.zip.Uncompress","setFlushMode",0xbecba0a3,"haxe.zip.Uncompress.setFlushMode","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",38,0x2e2bbf2e)
HX_LOCAL_STACK_FRAME(_hx_pos_5c4f2394ea68a40f_42_close,"haxe.zip.Uncompress","close",0x4cc86b9a,"haxe.zip.Uncompress.close","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",42,0x2e2bbf2e)
HX_LOCAL_STACK_FRAME(_hx_pos_5c4f2394ea68a40f_45_run,"haxe.zip.Uncompress","run",0x34f61ead,"haxe.zip.Uncompress.run","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",45,0x2e2bbf2e)
namespace haxe{
namespace zip{

void Uncompress_obj::__construct( ::Dynamic windowBits){
            	HX_STACKFRAME(&_hx_pos_5c4f2394ea68a40f_30_new)
...
bool Uncompress_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Uncompress_obj::execute( ::haxe::io::Bytes src,int srcPos, ::haxe::io::Bytes dst,int dstPos){
            	HX_STACKFRAME(&_hx_pos_5c4f2394ea68a40f_34_execute)
...
void Uncompress_obj::setFlushMode( ::haxe::zip::FlushMode f){
            	HX_STACKFRAME(&_hx_pos_5c4f2394ea68a40f_38_setFlushMode)
...
void Uncompress_obj::close(){
            	HX_STACKFRAME(&_hx_pos_5c4f2394ea68a40f_42_close)
...
HX_DEFINE_DYNAMIC_FUNC0(Uncompress_obj,close,(void))
 ...
 ::haxe::io::Bytes Uncompress_obj::run( ::haxe::io::Bytes src, ::Dynamic bufsize){
            	HX_GC_STACKFRAME(&_hx_pos_5c4f2394ea68a40f_45_run)
