...
HX_LOCAL_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_58_getSuperClass,"Type","getSuperClass",0xd9ffa85f,"Type.getSuperClass","/usr/local/lib/haxe/std/cpp/_std/Type.hx",58,0xb5f2d6e2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_103_createEnumIndex,"Type","createEnumIndex",0xd21e2c21,"Type.createEnumIndex","/usr/local/lib/haxe/std/cpp/_std/Type.hx",103,0xb5f2d6e2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_153_enumConstructor,"Type","enumConstructor",0x45f8fde5,"Type.enumConstructor","/usr/local/lib/haxe/std/cpp/_std/Type.hx",153,0xb5f2d6e2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_6ebc4c1d0351a436_170_allEnums,"Type","allEnums",0x86200985,"Type.allEnums","/usr/local/lib/haxe/std/cpp/_std/Type.hx",170,0xb5f2d6e2)
...
::hx::Class Type_obj::getSuperClass(::hx::Class c){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_58_getSuperClass)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Type_obj,createEnum,return )
 ...
 ::Dynamic Type_obj::createEnumIndex(::hx::Class e,int index,::cpp::VirtualArray params){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_103_createEnumIndex)
HXLINE( 104)		::String c = ::Type_obj::getEnumConstructs(e)->__get(index);
HXLINE( 105)		if (::hx::IsNull( c )) {
HXLINE( 106)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((index + HX_(" is not a valid enum constructor index",13,f3,cb,7c))));
            		}
...
::String Type_obj::enumConstructor( ::Dynamic e){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_153_enumConstructor)
...
::cpp::VirtualArray Type_obj::allEnums(::hx::Class e){
            	HX_STACKFRAME(&_hx_pos_6ebc4c1d0351a436_170_allEnums)
