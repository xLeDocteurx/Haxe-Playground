...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Flowfield", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("file", "Flowfield");
		app.meta.set("name", "Flowfield");
		app.meta.set("packageName", "com.sample.flowfield");
