...
HX_DECLARE_STACK_FRAME(_hx_pos_692c76051dac6459_240_new)
...
HXLINE( 241)		( ( ::sys::thread::_EventLoop::RegularEvent)(__this) )->run = run;
HXLINE( 242)		( ( ::sys::thread::_EventLoop::RegularEvent)(__this) )->nextRunTime = nextRunTime;
HXLINE( 243)		( ( ::sys::thread::_EventLoop::RegularEvent)(__this) )->interval = interval;
            	}
