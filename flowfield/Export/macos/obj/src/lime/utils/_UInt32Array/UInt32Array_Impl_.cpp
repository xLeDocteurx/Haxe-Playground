...
int UInt32Array_Impl__obj::BYTES_PER_ELEMENT;
 ...
 ::lime::utils::ArrayBufferView UInt32Array_Impl__obj::_new( ::Dynamic elements, ::haxe::io::Bytes buffer,::cpp::VirtualArray array, ::lime::utils::ArrayBufferView view, ::Dynamic __o_byteoffset, ::Dynamic len){
...
STATIC_HX_DEFINE_DYNAMIC_FUNC6(UInt32Array_Impl__obj,_new,return )
