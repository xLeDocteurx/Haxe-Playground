...
HXDLIN(1628)							_this->buffer = buffer2;
...
HXLINE(1645)				 ::haxe::io::Bytes bytes = ::sys::io::File_obj::getBytes(path);
HXLINE(1646)				 ::haxe::io::BytesInput input =  ::haxe::io::BytesInput_obj::__alloc( HX_CTX ,bytes,0,bytes->length);
HXLINE(1647)				 ::haxe::ds::List png =  ::format::png::Reader_obj::__alloc( HX_CTX ,input)->read();
HXLINE(1648)				 ::haxe::io::Bytes data = ::format::png::Tools_obj::extract32(png,null(),null());
HXLINE(1649)				 ::Dynamic header = ::format::png::Tools_obj::getHeader(png);
HXLINE(1651)				 ::Dynamic elements = null();
HXDLIN(1651)				 ::haxe::io::Bytes buffer1 = ::haxe::io::Bytes_obj::ofData(data->b);
HXDLIN(1651)				::cpp::VirtualArray array = null();
HXDLIN(1651)				 ::lime::utils::ArrayBufferView view = null();
HXDLIN(1651)				 ::Dynamic len = null();
HXDLIN(1651)				 ::lime::utils::ArrayBufferView this1;
HXDLIN(1651)				if (::hx::IsNotNull( elements )) {
HXLINE(1651)					this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            				}
            				else {
HXLINE(1651)					if (::hx::IsNotNull( array )) {
HXLINE(1651)						 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1651)						_this->byteOffset = 0;
HXDLIN(1651)						_this->length = array->get_length();
HXDLIN(1651)						_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1651)						 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1651)						_this->buffer = this2;
HXDLIN(1651)						_this->copyFromArray(array,null());
HXDLIN(1651)						this1 = _this;
            					}
            					else {
HXLINE(1651)						if (::hx::IsNotNull( view )) {
HXLINE(1651)							 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1651)							 ::haxe::io::Bytes srcData = view->buffer;
HXDLIN(1651)							int srcLength = view->length;
HXDLIN(1651)							int srcByteOffset = view->byteOffset;
HXDLIN(1651)							int srcElementSize = view->bytesPerElement;
HXDLIN(1651)							int elementSize = _this->bytesPerElement;
HXDLIN(1651)							if ((view->type == _this->type)) {
HXLINE(1651)								int srcLength = srcData->length;
HXDLIN(1651)								int cloneLength = (srcLength - srcByteOffset);
HXDLIN(1651)								 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1651)								_this->buffer = this1;
HXDLIN(1651)								_this->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE(1651)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("unimplemented",09,2f,74,b4)));
            							}
HXDLIN(1651)							_this->byteLength = (_this->bytesPerElement * srcLength);
HXDLIN(1651)							_this->byteOffset = 0;
HXDLIN(1651)							_this->length = srcLength;
HXDLIN(1651)							this1 = _this;
            						}
            						else {
HXLINE(1651)							if (::hx::IsNotNull( buffer1 )) {
HXLINE(1651)								 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1651)								int in_byteOffset = 0;
HXDLIN(1651)								if ((in_byteOffset < 0)) {
HXLINE(1651)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
HXDLIN(1651)								if ((::hx::Mod(in_byteOffset,_this->bytesPerElement) != 0)) {
HXLINE(1651)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
HXDLIN(1651)								int bufferByteLength = buffer1->length;
HXDLIN(1651)								int elementSize = _this->bytesPerElement;
HXDLIN(1651)								int newByteLength = bufferByteLength;
HXDLIN(1651)								if (::hx::IsNull( len )) {
HXLINE(1651)									newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN(1651)									if ((::hx::Mod(bufferByteLength,_this->bytesPerElement) != 0)) {
HXLINE(1651)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
HXDLIN(1651)									if ((newByteLength < 0)) {
HXLINE(1651)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
            								}
            								else {
HXLINE(1651)									newByteLength = (( (int)(len) ) * _this->bytesPerElement);
HXDLIN(1651)									int newRange = (in_byteOffset + newByteLength);
HXDLIN(1651)									if ((newRange > bufferByteLength)) {
HXLINE(1651)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
            								}
HXDLIN(1651)								_this->buffer = buffer1;
HXDLIN(1651)								_this->byteOffset = in_byteOffset;
HXDLIN(1651)								_this->byteLength = newByteLength;
HXDLIN(1651)								_this->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this->bytesPerElement) )));
HXDLIN(1651)								this1 = _this;
            							}
            							else {
HXLINE(1651)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85)));
            							}
            						}
            					}
            				}
HXDLIN(1651)				 ::lime::utils::ArrayBufferView data1 = this1;
HXLINE(1652)				int length = (( (int)(header->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic)) ) * ( (int)(header->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic)) ));
HXLINE(1653)				 ::Dynamic b;
HXDLIN(1653)				 ::Dynamic g;
HXDLIN(1653)				 ::Dynamic r;
HXDLIN(1653)				 ::Dynamic a;
HXLINE(1655)				{
HXLINE(1655)					int _g = 0;
HXDLIN(1655)					int _g1 = length;
HXDLIN(1655)					while((_g < _g1)){
HXLINE(1655)						_g = (_g + 1);
HXDLIN(1655)						int i = (_g - 1);
HXLINE(1657)						 ::Dynamic b = ( ::__hxcpp_memory_get_byte(data1->buffer->b,(data1->byteOffset + (i * 4))) & 255);
HXLINE(1658)						 ::Dynamic g = ( ::__hxcpp_memory_get_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 1))) & 255);
HXLINE(1659)						 ::Dynamic r = ( ::__hxcpp_memory_get_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 2))) & 255);
HXLINE(1660)						 ::Dynamic a = ( ::__hxcpp_memory_get_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 3))) & 255);
HXLINE(1662)						{
HXLINE(1662)							int val = ( (int)(r) );
HXDLIN(1662)							 ::__hxcpp_memory_set_byte(data1->buffer->b,(data1->byteOffset + (i * 4)),val);
            						}
HXLINE(1663)						{
HXLINE(1663)							int val1 = ( (int)(g) );
HXDLIN(1663)							 ::__hxcpp_memory_set_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 1)),val1);
            						}
HXLINE(1664)						{
HXLINE(1664)							int val2 = ( (int)(b) );
HXDLIN(1664)							 ::__hxcpp_memory_set_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 2)),val2);
            						}
HXLINE(1665)						{
HXLINE(1665)							int val3 = ( (int)(a) );
HXDLIN(1665)							 ::__hxcpp_memory_set_byte(data1->buffer->b,(data1->byteOffset + ((i * 4) + 3)),val3);
            						}
            					}
            				}
HXLINE(1668)				buffer =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,data1,header->__Field(HX_("width",06,b6,62,ca),::hx::paccDynamic),header->__Field(HX_("height",e7,07,4c,02),::hx::paccDynamic),null(),null());
            			} catch( ::Dynamic _hx_e) {
