...
HX_LOCAL_STACK_FRAME(_hx_pos_9ba24db561a9c477_175_withExtension,"haxe.io.Path","withExtension",0x256d3570,"haxe.io.Path.withExtension","/usr/local/lib/haxe/std/haxe/io/Path.hx",175,0xc99b0f1c)
...
::String Path_obj::withExtension(::String path,::String ext){
            	HX_GC_STACKFRAME(&_hx_pos_9ba24db561a9c477_175_withExtension)
