...
HX_LOCAL_STACK_FRAME(_hx_pos_3a888173c8ad0c39_83_set_position,"haxe.io.BytesInput","set_position",0xafd318f5,"haxe.io.BytesInput.set_position","/usr/local/lib/haxe/std/haxe/io/BytesInput.hx",83,0x977e71a2)
...
int BytesInput_obj::set_position(int p){
            	HX_STACKFRAME(&_hx_pos_3a888173c8ad0c39_83_set_position)
HXLINE(  84)		if ((p < 0)) {
HXLINE(  85)			p = 0;
            		}
            		else {
