...
HX_LOCAL_STACK_FRAME(_hx_pos_28668287f4db9634_137_remove,"haxe.ds.List","remove",0x3f86961d,"haxe.ds.List.remove","/usr/local/lib/haxe/std/haxe/ds/List.hx",137,0x54f95eac)
namespace haxe{
namespace ds{
...
bool List_obj::remove( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_28668287f4db9634_137_remove)
