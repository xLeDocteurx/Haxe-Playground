...
HX_LOCAL_STACK_FRAME(_hx_pos_009433530f8e647c_34_execute,"haxe.zip.Compress","execute",0xd015e2fe,"haxe.zip.Compress.execute","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",34,0x9f8c8027)
HX_LOCAL_STACK_FRAME(_hx_pos_009433530f8e647c_38_setFlushMode,"haxe.zip.Compress","setFlushMode",0x35ab82dc,"haxe.zip.Compress.setFlushMode","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",38,0x9f8c8027)
HX_LOCAL_STACK_FRAME(_hx_pos_009433530f8e647c_42_close,"haxe.zip.Compress","close",0x6942fc41,"haxe.zip.Compress.close","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",42,0x9f8c8027)
HX_LOCAL_STACK_FRAME(_hx_pos_009433530f8e647c_45_run,"haxe.zip.Compress","run",0x4ddf6794,"haxe.zip.Compress.run","/usr/local/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",45,0x9f8c8027)
namespace haxe{
namespace zip{
