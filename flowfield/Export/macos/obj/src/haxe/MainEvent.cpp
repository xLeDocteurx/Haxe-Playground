...
HX_LOCAL_STACK_FRAME(_hx_pos_593a9917e735e8fd_47_stop,"haxe.MainEvent","stop",0xbe8005d7,"haxe.MainEvent.stop","/usr/local/lib/haxe/std/haxe/MainLoop.hx",47,0x4a7d9295)
namespace haxe{
...
void MainEvent_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_593a9917e735e8fd_47_stop)
HXLINE(  48)		if (::hx::IsNull( this->f )) {
HXLINE(  49)			return;
            		}
HXLINE(  50)		this->f = null();
HXLINE(  51)		this->nextRun = ::Math_obj::NEGATIVE_INFINITY;
HXLINE(  52)		if (::hx::IsNull( this->prev )) {
HXLINE(  53)			::haxe::MainLoop_obj::pending = this->next;
            		}
            		else {
HXLINE(  55)			this->prev->next = this->next;
            		}
HXLINE(  56)		if (::hx::IsNotNull( this->next )) {
HXLINE(  57)			this->next->prev = this->prev;
            		}
            	}
