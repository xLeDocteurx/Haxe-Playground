...
HX_DEFINE_STACK_FRAME(_hx_pos_692c76051dac6459_240_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","/usr/local/lib/haxe/std/sys/thread/EventLoop.hx",240,0xbeb01246)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_692c76051dac6459_240_new)
HXLINE( 241)		this->run = run;
HXLINE( 242)		this->nextRunTime = nextRunTime;
HXLINE( 243)		this->interval = interval;
            	}
