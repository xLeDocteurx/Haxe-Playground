...
HX_LOCAL_STACK_FRAME(_hx_pos_3a0a066c26bdae40_33_getBytes,"sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","/usr/local/lib/haxe/std/cpp/_std/sys/io/File.hx",33,0x3272313d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3a0a066c26bdae40_69_copy,"sys.io.File","copy",0x165a7840,"sys.io.File.copy","/usr/local/lib/haxe/std/cpp/_std/sys/io/File.hx",69,0x3272313d)
namespace sys{
namespace io{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(File_obj,getContent,return )
 ...
 ::haxe::io::Bytes File_obj::getBytes(::String path){
            	HX_STACKFRAME(&_hx_pos_3a0a066c26bdae40_33_getBytes)
...
void File_obj::copy(::String srcPath,::String dstPath){
            	HX_STACKFRAME(&_hx_pos_3a0a066c26bdae40_69_copy)
