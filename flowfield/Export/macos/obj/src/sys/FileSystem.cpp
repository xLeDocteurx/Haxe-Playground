...
HX_LOCAL_STACK_FRAME(_hx_pos_4ebd30807fe7ed8d_35_rename,"sys.FileSystem","rename",0x3aa2fb40,"sys.FileSystem.rename","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",35,0x1f6d7d6f)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4ebd30807fe7ed8d_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",78,0x1f6d7d6f)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4ebd30807fe7ed8d_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","/usr/local/lib/haxe/std/cpp/_std/sys/FileSystem.hx",101,0x1f6d7d6f)
namespace sys{
...
void FileSystem_obj::rename(::String path,::String newPath){
            	HX_STACKFRAME(&_hx_pos_4ebd30807fe7ed8d_35_rename)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_4ebd30807fe7ed8d_78_createDirectory)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_4ebd30807fe7ed8d_101_readDirectory)
